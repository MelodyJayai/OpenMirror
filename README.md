...
> 状态：早期开发中。当前已实现 mDNS 服务发现、RTSP 控制通道、二进制 plist 编解码、AirPlay legacy 配对、媒体端口分配、镜像 TCP/音频 RTP 接收、NTP timing 应答与 H.264 Annex-B 转换。真实 FairPlay 解密、音视频解码和渲染仍在开发。详见 [开发计划](docs/DEVELOPMENT_PLAN.md)。
